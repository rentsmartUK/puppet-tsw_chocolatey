class custom_chocolatey (
  ...
  file { 'chocolatey_binary':
    ...
    path    => "$chocolatey_binary_path/chocolatey-$chocolatey_version.nupkg",
  ...
  class { 'chocolatey':
    ...
    chocolatey_download_url => "file:///$chocolatey_binary_path/chocolatey-$chocolatey_version.nupkg",
